package com.ybwh.tranformData.jdbc;
					...
					if (field.isAnnotationPresent(Id.class)) {
						...
						if (o != null) {
							...
							if (String.class.equals(fieldType)) {
								colNamelist.add(column.name() + "=?");
								objList.add(CoreConstant.FieldDefaultValue.STRING_DEFAULT_VALUE);
							} else if (Date.class.equals(fieldType) || Timestamp.class.equals(fieldType)) {
								colNamelist.add(
										column.name() + "='" + CoreConstant.FieldDefaultValue.DATE_DEFAULT_VALUE + "'");
							} else if (Integer.TYPE.equals(fieldType) || Integer.class.equals(fieldType)) {
								colNamelist.add(column.name() + "=?");
								objList.add(CoreConstant.FieldDefaultValue.INTEGER_DEFAULT_VALUE);

							} else if (Long.TYPE.equals(fieldType) || Long.class.equals(fieldType)) {
								colNamelist.add(column.name() + "=?");
								objList.add(CoreConstant.FieldDefaultValue.LONG_DEFAULT_VALUE);
							} else if (Float.TYPE.equals(fieldType) || Float.class.equals(fieldType)) {

								colNamelist.add(column.name() + "=?");
								objList.add(CoreConstant.FieldDefaultValue.FLOAT_DEFAULT_VALUE);
							} else {
								continue;
							}
						}
