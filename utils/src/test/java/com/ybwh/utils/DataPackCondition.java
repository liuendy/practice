...
public class DataPackCondition {
    ...
    public static class CarCondition<T> {
		...
		public String toString() {
			return "CarCondition [conditionName=" + conditionName + ", conditionValue=" + conditionValue
					+ ", base64Data=" + base64Data + ", desc=" + desc + "]";
		}
    }
	...
	@Override
	public String toString() {
		return "DataPackCondition [conditionList=" + conditionList + "]";
	}
