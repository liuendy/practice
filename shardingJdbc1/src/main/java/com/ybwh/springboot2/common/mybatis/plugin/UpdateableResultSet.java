...
class UpdateableResultSet implements ResultSet {
     ...
     * 存储当前数据行是否被修改过
     */
    protected List<Boolean> rowUpdateds = new ArrayList<Boolean>();
    ...
    public UpdateableResultSet(Statement statement) throws SQLException {
        super();
...
//            System.out.println("*******" + metaData.getColumnLabel(i) + "->" + metaData.getColumnName(i)+":"+i);
        ...
        int totalCol = metaData.getColumnCount();
        while (rs.next()) {
            Object[] row = new Object[totalCol];
...
//        System.out.println("##########"+columnIndex+","+(null == obj?null:obj.getClass())+","+obj);
    ...
    public boolean rowUpdated() throws SQLException {
        ...
        return rowUpdateds.get(rowIndex);
    }
    ...
    public boolean relative(int rows) throws SQLException {
        ...
        int targetRowIndex = rowIndex + rows;
        if (targetRowIndex < 0 || targetRowIndex > this.rows.size()) {
            return false;
        }
